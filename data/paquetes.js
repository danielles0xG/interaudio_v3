...
const Paquete_100_personas = {
    ...
    data: [
                ...
                },
                {
                    ...
                    tip  : '2 bocinas Monitores de referencia activos de 8", Mezcladora de 8 canales con efectos e interfaz USB, 1 micrófono y cables premium'
                },
                {
                    info : 'Cajas directas, interfaz USB, snakes ethercon, atriles, etc.',
                    tip  : null
                },
                {
